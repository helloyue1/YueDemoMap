...
const loadData = async () => {
  try {
    tableData.value = [
      { id: 1, visitorName: '王先生', visitorPhone: '13900139000', elderlyName: '张大爷', roomNumber: '101', visitDate: '2024-01-16', visitTime: '10:00-12:00', status: 1 },
      { id: 2, visitorName: '李女士', visitorPhone: '13800138000', elderlyName: '李奶奶', roomNumber: '102', visitDate: '2024-01-16', visitTime: '14:00-16:00', status: 0 }
    ]
    pagination.total = 2
  } catch (error) {
